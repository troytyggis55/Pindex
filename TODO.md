...
- [ ] **Storage bucket RLS** — Add row-level security policies to all three Supabase Storage buckets (`pin-images`, `org-logos`, `profile-images`): public read, authenticated write scoped to the owner or org admin.
